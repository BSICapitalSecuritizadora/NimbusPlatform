...
class IntegralizationHistorySpreadsheetTemplate
{
    public const DOWNLOAD_NAME = 'Template - Histórico de Integralizações.xlsx';

    protected const CUSTOM_TEMPLATE_DISK = 'local';

    protected const CUSTOM_TEMPLATE_PATH = 'integralization-history-templates/template-historico-de-integralizacoes.xlsx';

    protected const DEFAULT_TEMPLATE_PATH = 'resources/templates/integralization-histories/template-historico-de-integralizacoes.xlsx';
