...
class PaymentSpreadsheetTemplate
{
    ...
    protected const CUSTOM_TEMPLATE_PATH = 'payment-templates/template-fluxo-de-pagamento.xlsx';

    protected const DEFAULT_TEMPLATE_PATH = 'resources/templates/payments/template-fluxo-de-pagamento.xlsx';
