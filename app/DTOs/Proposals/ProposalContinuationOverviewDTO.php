...
readonly class ProposalContinuationOverviewDTO
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            requestedAmount: ProposalProject::normalizeDecimalValue($data['requested_amount'] ?? 0),
            landMarketValue: self::nullableDecimal($data['land_market_value'] ?? null),
            landArea: ProposalProject::normalizeDecimalValue($data['land_area'] ?? 0),
