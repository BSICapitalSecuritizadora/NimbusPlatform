...
enum AccessPermission: string
{
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::NimbusSubmissionsView => 'NimbusDocs envios: visualizar',
            self::NimbusSubmissionsUpdate => 'NimbusDocs envios: editar',
            self::NimbusSubmissionsDelete => 'NimbusDocs envios: excluir',
            self::NimbusPortalUsersView => 'NimbusDocs usuários: visualizar',
            self::NimbusPortalUsersCreate => 'NimbusDocs usuários: criar',
            self::NimbusPortalUsersUpdate => 'NimbusDocs usuários: editar',
            self::NimbusPortalUsersDelete => 'NimbusDocs usuários: excluir',
            self::NimbusAccessTokensView => 'NimbusDocs chaves: visualizar',
            self::NimbusAccessTokensCreate => 'NimbusDocs chaves: criar',
            self::NimbusAccessTokensUpdate => 'NimbusDocs chaves: editar',
            self::NimbusAccessTokensDelete => 'NimbusDocs chaves: excluir',
            self::NimbusDocumentCategoriesView => 'NimbusDocs categorias: visualizar',
            self::NimbusDocumentCategoriesCreate => 'NimbusDocs categorias: criar',
            self::NimbusDocumentCategoriesUpdate => 'NimbusDocs categorias: editar',
            self::NimbusDocumentCategoriesDelete => 'NimbusDocs categorias: excluir',
            self::NimbusGeneralDocumentsView => 'NimbusDocs biblioteca geral: visualizar',
            self::NimbusGeneralDocumentsCreate => 'NimbusDocs biblioteca geral: criar',
            self::NimbusGeneralDocumentsUpdate => 'NimbusDocs biblioteca geral: editar',
            self::NimbusGeneralDocumentsDelete => 'NimbusDocs biblioteca geral: excluir',
            self::NimbusPortalDocumentsView => 'NimbusDocs documentos por usuário: visualizar',
            self::NimbusPortalDocumentsCreate => 'NimbusDocs documentos por usuário: criar',
            self::NimbusPortalDocumentsUpdate => 'NimbusDocs documentos por usuário: editar',
            self::NimbusPortalDocumentsDelete => 'NimbusDocs documentos por usuário: excluir',
            self::NimbusAnnouncementsView => 'NimbusDocs avisos: visualizar',
            self::NimbusAnnouncementsCreate => 'NimbusDocs avisos: criar',
            self::NimbusAnnouncementsUpdate => 'NimbusDocs avisos: editar',
            self::NimbusAnnouncementsDelete => 'NimbusDocs avisos: excluir',
            self::NimbusNotificationOutboxesView => 'NimbusDocs auditoria de envios: visualizar',
            self::NimbusNotificationSettingsView => 'NimbusDocs notificações: visualizar',
            self::NimbusNotificationSettingsUpdate => 'NimbusDocs notificações: editar',
    ...
    public function group(): string
    {
        return match (true) {
            ...
            str_starts_with($this->value, 'nimbus.') => 'NimbusDocs',
