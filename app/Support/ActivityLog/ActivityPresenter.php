...
final class ActivityPresenter
{
    ...
    private const FIELD_LABELS = [
        ...
        'bsi_code' => 'Código BSI',
        'if_code' => 'Código IF',
        'isin_code' => 'Código ISIN',
        'phase' => 'Fase',
        'operation_type' => 'Tipo de operação',
        'registered_with_cvm' => 'Registrada na CVM',
        'issuer_situation' => 'Situação da emissora',
        'fiduciary_regime' => 'Regime fiduciário',
        'form_type' => 'Forma',
        'monetary_update_period' => 'Prazo de atualização monetária',
        'interest_payment_frequency' => 'Frequência de juros',
        'amortization_frequency' => 'Frequência de amortização',
        'prepayment_possibility' => 'Possibilidade de resgate antecipado',
        'target_audience' => 'Público-alvo',
        'segment' => 'Segmento de atuação',
        'offer_type' => 'Tipo de oferta',
        'remuneration_indexer' => 'Indexador de remuneração',
        'remuneration_rate' => 'Taxa de remuneração',
        'benchmark' => 'Indexador',
        'nominal_rate' => 'Taxa nominal',
        'spread_rate' => 'Spread',
        'issued_price' => 'Preço unitário emitido',
        'issued_quantity' => 'Quantidade emitida',
        'integralized_quantity' => 'Quantidade integralizada',
        'remaining_quantity' => 'Quantidade remanescente',
        'issued_volume' => 'Volume total emitido',
        'issue_amount' => 'Volume da emissão',
        'series_count' => 'Número de séries',
        'guarantee_fund' => 'Fundo de garantia',
        'expense_fund' => 'Fundo de despesas',
        'liquidity_fund' => 'Fundo de liquidez',
        'reserve_fund' => 'Fundo de reserva',
        'risk_rating' => 'Rating de risco',
        'public_trading_code' => 'Código de negociação B3',
        'trading_environment' => 'Ambiente de negociação',
        'issuer' => 'Emissor',
        'issuer_name' => 'Emissora',
        'lead_coordinator' => 'Coordenador líder',
        'lead_underwriter_id' => 'Coordenador líder',
        'settlement_bank' => 'Banco liquidante',
        'registrar' => 'Escriturador',
        'distributor' => 'Distribuidor',
        'trustee_agent' => 'Agente fiduciário',
        'trustee_id' => 'Agente fiduciário',
        'debtor' => 'Devedor / Cedente',
        'law_firm' => 'Assessoria jurídica',
        'issue_date' => 'Data de emissão',
        'maturity_date' => 'Data de vencimento',
        'tax_type' => 'Tributação',
        'amortization_type' => 'Amortização',
        'destination_of_funds' => 'Destinação dos recursos',
        'subscription_conditions' => 'Condições de subscrição e integralização',
        'repurchase_conditions' => 'Repactuação',
        'amortization_schedule' => 'Calendário de pagamento da amortização',
        'remuneration_schedule' => 'Calendário de pagamento da remuneração',
        'early_redemption_conditions' => 'Resgate antecipado facultativo',
        'early_amortization_conditions' => 'Amortização antecipada',
        'remuneration_calculation' => 'Cálculo da remuneração',
        'penalty_conditions' => 'Multa e juros moratórios',
        'underlying_asset' => 'Descrição do lastro',
        'covenant_conditions' => 'Obrigações adicionais (covenants)',
        'cross_default_conditions' => 'Vencimento antecipado (cross-default)',
        'operational_structure' => 'Estrutura da operação',
