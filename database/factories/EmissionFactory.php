...
class EmissionFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'target_audience' => fake()->randomElement(['Investidores Qualificados', 'Investidores Profissionais', 'Público em Geral']),
            ...
            'fiduciary_assignment' => fake()->randomElement(['Sim', 'Não']),
            'vehicle_fiduciary_alienation' => fake()->randomElement(['Sim', 'Não']),
            'quota_fiduciary_alienation' => fake()->randomElement(['Sim', 'Não']),
            'surety' => fake()->randomElement(['Sim', 'Não']),
            'real_estate_guarantee' => fake()->randomElement(['Sim', 'Não']),
            'property_fiduciary_alienation' => fake()->randomElement(['Sim', 'Não']),
            'aval' => fake()->randomElement(['Sim', 'Não']),
