...
class ObligationSeriesFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'relative_offset_quantity' => null,
            'relative_offset_unit' => null,
            'relative_offset_direction' => null,
            'anchor_description' => null,
            'initial_date_inclusion' => null,
        ...
        return $this
            ...
            ->afterCreating(function (ObligationSeries $series): void {
                ObligationSeriesRule::factory()->for($series, 'series')->create([
                    ...
                    'relative_offset_quantity' => $series->relative_offset_quantity,
                    'relative_offset_unit' => $series->relative_offset_unit,
                    'relative_offset_direction' => $series->relative_offset_direction,
                    'anchor_description' => $series->anchor_description,
                    'initial_date_inclusion' => $series->initial_date_inclusion,
