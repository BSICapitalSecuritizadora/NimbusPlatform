...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $editor->syncPermissions([
            ...
            'legal-instruments.attach_document', 'legal-instruments.process_document',
            'legal-instruments.review_changes', 'legal-instruments.confirm_change',
            ...
            'contract-installments.view', 'contract-installments.create', 'contract-installments.update',
            ...
            'delegations.view', 'delegations.create', 'delegations.revoke',
