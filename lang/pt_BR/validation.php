...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Mapeia os nomes técnicos dos campos para rótulos legíveis em português,
    | usados no lugar de ":attribute" nas mensagens de erro.
    |
    */
    ...
    'attributes' => [
        ...
        'landMarketValue' => 'valor de mercado do terreno',
        'landArea' => 'área do terreno',
        'launchDate' => 'lançamento',
        'salesLaunchDate' => 'lançamento das vendas',
        'constructionStartDate' => 'início das obras',
        'deliveryForecastDate' => 'previsão de entrega',
        'remainingMonths' => 'prazo remanescente',
        'zipCode' => 'CEP',
        'street' => 'rua',
        ...
        'state' => 'estado',
        'blockCount' => 'blocos',
        'floorCount' => 'pavimentos',
        'typicalFloorCount' => 'andares tipo',
        'unitsPerFloor' => 'unidades por andar',
        'totalUnits' => 'total de unidades',
        'projects' => 'empreendimentos',
        'projects.*.name' => 'identificação do empreendimento',
        'projects.*.exchangedUnits' => 'unidades permutadas',
        'projects.*.paidUnits' => 'unidades quitadas',
        'projects.*.unpaidUnits' => 'unidades não quitadas',
        'projects.*.stockUnits' => 'unidades em estoque',
        'projects.*.incurredCost' => 'custo incorrido',
        'projects.*.costToIncur' => 'custo a incorrer',
        'projects.*.paidSalesValue' => 'valor de vendas quitadas',
        'projects.*.unpaidSalesValue' => 'valor de vendas não quitadas',
        'projects.*.stockSalesValue' => 'valor de estoque',
        'projects.*.receivedValue' => 'valor já recebido',
        'projects.*.valueUntilKeys' => 'valor até as chaves',
        'projects.*.valueAfterKeys' => 'valor após as chaves',
        'unitTypes' => 'tipologias',
        'unitTypes.*.totalUnits' => 'total de unidades',
        'unitTypes.*.bedrooms' => 'dormitórios',
        'unitTypes.*.parkingSpaces' => 'vagas',
        'unitTypes.*.usableArea' => 'área útil',
        'unitTypes.*.averagePrice' => 'preço médio',
        'uploads' => 'arquivos',
        'uploads.*' => 'arquivo',
    ],
