        ...
        <div style="background:#fff;border:1px solid #e5e7eb;border-top:0;border-radius:0 0 16px 16px;padding:32px;">
            ...
            <div style="text-align:center;margin:32px 0;">
                <a href="{{ route('register', ['token' => $invitation->token]) }}"
                   style="display:inline-block;background:#001233;color:#fff;text-decoration:none;font-weight:700;font-size:15px;padding:14px 32px;border-radius:8px;letter-spacing:.02em;">
                    Concluir cadastro
                </a>
            </div>
            ...
            <p style="font-size:13px;color:#001233;word-break:break-all;">
