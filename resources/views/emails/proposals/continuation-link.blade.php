    ...
    <div style="max-width:640px;margin:0 auto;padding:32px 20px;">
        ...
        <div style="background:#fff;border:1px solid #e5e7eb;border-top:0;border-radius:0 0 16px 16px;padding:32px;">
            ...
            <div style="margin:28px 0;">
                <a href="{{ $continuationUrl }}" style="display:inline-block;background:#001233;color:#fff;text-decoration:none;padding:14px 28px;border-radius:10px;font-weight:700;font-size:15px;">
            ...
            <div style="background:#f8fafc;border:1px solid #dbe4f0;border-radius:12px;padding:20px;">
                ...
                <div style="font-size:32px;font-weight:700;letter-spacing:0.2em;color:#001233;">{{ $code }}</div>
            </div>
