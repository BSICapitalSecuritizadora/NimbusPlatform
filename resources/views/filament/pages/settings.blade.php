                ...
                <div class="space-y-6 px-6 py-6 sm:px-8">
                    <div class="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
                        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                            <div class="space-y-3">
                                <div class="flex flex-wrap items-center gap-2">
                                    <span class="inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold {{ $this->getPuHistoryTemplateStatusClasses() }}">
                                        {{ $this->getPuHistoryTemplateStatusLabel() }}
                                    </span>
                                    <span class="text-xs text-gray-500">Arquivo disponibilizado no histórico de PU</span>
                                </div>

                                <p class="text-sm leading-6 text-gray-400">
                                    {{ $this->getPuHistoryTemplateDescription() }}
                                </p>
                            </div>
                ...
                <div class="space-y-6 px-6 py-6 sm:px-8">
                    <div class="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
                        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                            <div class="space-y-3">
                                <div class="flex flex-wrap items-center gap-2">
                                    <span class="inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold {{ $this->getIntegralizationHistoryTemplateStatusClasses() }}">
                                        {{ $this->getIntegralizationHistoryTemplateStatusLabel() }}
                                    </span>
                                    <span class="text-xs text-gray-500">Arquivo disponibilizado no histórico de integralizações</span>
                                </div>

                                <p class="text-sm leading-6 text-gray-400">
                                    {{ $this->getIntegralizationHistoryTemplateDescription() }}
                                </p>
                            </div>
                    ...
                    <form wire:submit="saveIntegralizationHistoryTemplate" class="space-y-5">
                        <div class="space-y-2">
                            ...
                            @error('integralizationHistoryTemplateFile')
                                <p class="text-sm font-medium text-rose-300">{{ $message }}</p>
                            @enderror
                        </div>
