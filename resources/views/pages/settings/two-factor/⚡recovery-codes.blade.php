            ...
            <div class="mt-3 space-y-3">
                ...
                @if (filled($recoveryCodes))
                    ...
                    <flux:text variant="subtle" class="text-xs">
                        {{ __('Cada código de recuperação pode ser utilizado apenas uma vez e será removido após o uso. Caso precise de novos códigos, clique em Gerar novos códigos acima.') }}
                    </flux:text>
                @endif
            </div>
        </div>
