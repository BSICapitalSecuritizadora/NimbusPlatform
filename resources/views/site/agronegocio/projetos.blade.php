        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <h1 class="display-3 fw-bold mb-4" style="color: #ffffff; letter-spacing: -0.02em;">
                    Expansão e <br><span style="color: var(--gold);">Projetos Especiais</span>
                </h1>
                <p class="lead mb-5" style="color: #a5b4fc; max-width: 90%;">
                    Captação de recursos para aquisição de áreas, modernização de maquinário e transição energética no campo através de operações customizadas.
                </p>
...
<section class="py-5" style="background-color: var(--bg);">
    <div class="container py-5">
        <div class="text-center mb-5 pb-3">
            <h2 class="h3 fw-bold text-dark mb-3">Desenvolvimento a Longo Prazo</h2>
            <p class="text-muted mx-auto" style="max-width: 600px;">Apoiamos o crescimento tecnológico e a infraestrutura sustentável para produtores de todos os portes.</p>
        </div>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <h3 class="h5 fw-bold mb-3" style="color: #0b1220;">Investimento em Infraestrutura</h3>
                    <p class="text-muted mb-0">Fundos estruturados para a construção de armazéns, irrigação central e renovação tecnológica com longo prazo de maturação.</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <h3 class="h5 fw-bold mb-3" style="color: #0b1220;">Aquisição de Terras</h3>
                    <p class="text-muted mb-0">Aproveite janelas de oportunidade com emissão de debêntures e fundos atrelados à terra, otimizando seu passivo imobiliário.</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <h3 class="h5 fw-bold mb-3" style="color: #0b1220;">Transição Energética</h3>
                    <p class="text-muted mb-0">Viabilização de projetos de energia solar, biogás e biodigestores através de títulos corporativos sustentáveis (Green Bonds).</p>
                </div>
            </div>
        </div>
    </div>
