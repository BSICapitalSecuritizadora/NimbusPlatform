        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <h1 class="display-3 fw-bold mb-4" style="color: #ffffff; letter-spacing: -0.02em;">
                    Expansão e <br><span style="color: var(--gold);">Projetos Estratégicos</span>
                </h1>
                <p class="lead mb-5" style="color: #a5b4fc; max-width: 90%;">
                    Estruturação de capital para expansão, modernização operacional e projetos de infraestrutura no agronegócio, com soluções adaptadas ao perfil de cada investimento.
                </p>
...
<section class="py-5" style="background-color: var(--bg);">
    <div class="container py-5">
        <div class="text-center mb-5 pb-3">
            <h2 class="h3 fw-bold text-dark mb-3">Capital para crescimento e transformação operacional</h2>
            <p class="text-muted mx-auto" style="max-width: 600px;">Soluções voltadas a projetos de expansão, ganhos de eficiência e modernização da infraestrutura produtiva no campo.</p>
        </div>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <p class="text-muted mb-0">Estruturas para financiar armazenagem, irrigação, logística e melhoria operacional com horizonte compatível com projetos de maturação mais longa.</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <h3 class="h5 fw-bold mb-3" style="color: #0b1220;">Aquisição e expansão de áreas</h3>
                    <p class="text-muted mb-0">Modelagem financeira para oportunidades de aquisição de terras e reorganização patrimonial vinculada ao crescimento da operação rural.</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <p class="text-muted mb-0">Soluções para projetos de energia solar, biogás e outras iniciativas voltadas à eficiência energética e à sustentabilidade no agronegócio.</p>
                </div>
            </div>
        </div>
    </div>
