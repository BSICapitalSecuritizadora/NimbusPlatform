        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-6">
                <div class="card border-0 p-5" style="background: linear-gradient(135deg, rgba(0,32,91,0.04), rgba(212,175,55,0.04)); border-radius: 20px;">
                    <h4 class="fw-bold mb-4" style="color: var(--brand); font-size: 1.1rem;">Nossos Pilares de Controle</h4>
                    <div class="d-flex flex-column gap-3">
...
<!-- Canal de Ética -->
<section class="py-5" style="background-color: var(--bg); border-top: 1px solid rgba(0,0,0,0.05);">
                    ...
                    <div class="row g-0 align-items-stretch">
                        <div class="col-md-4 p-5 d-flex flex-column justify-content-center align-items-center text-center position-relative" style="background: linear-gradient(145deg, rgba(240,240,240,0.6), rgba(255,255,255,1)); border-right: 1px solid rgba(0,0,0,0.04);">
                            <div class="rounded-circle d-flex align-items-center justify-content-center mb-4 shadow-sm" style="width: 80px; height: 80px; background: #fff; border: 1px solid rgba(212,175,55,0.2);">
                                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
                            </div>
                            <h3 class="h4 fw-bold mb-0 text-dark" style="font-family: var(--font-heading);">Canal de Ética</h3>
                        </div>
                        <div class="col-md-8 p-5 d-flex flex-column justify-content-center">
                            ...
                            <div class="d-flex flex-wrap gap-3 mt-2">
                                ...
                                <a href="{{ route('site.contact') }}" class="btn d-inline-flex align-items-center gap-2 px-4 py-3" style="border-radius: 10px; border: 1px solid rgba(0,32,91,0.15); color: var(--brand); background: #fff; transition: all 0.3s ease;">
