        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <h1 class="display-3 fw-bold mb-4" style="color: #ffffff; letter-spacing: -0.02em;">
                    Financiamento de <br><span style="color: var(--gold);">Loteamentos</span>
                </h1>
                <p class="lead mb-5" style="color: #a5b4fc; max-width: 90%;">
                    Estruturas customizadas para financiar a aquisição de glebas, desenvolvimento de infraestrutura e expansão de loteamentos residenciais e comerciais.
                </p>
...
<section class="py-5" style="background-color: var(--bg);">
    <div class="container py-5">
        <div class="text-center mb-5 pb-3">
            <h2 class="h3 fw-bold text-dark mb-3">Soluções para Loteadores Sustentáveis</h2>
            <p class="text-muted mx-auto" style="max-width: 600px;">Desenvolvemos operações financeiras ágeis alinhadas ao cronograma físico-financeiro das suas obras.</p>
        </div>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <h3 class="h5 fw-bold mb-3" style="color: #0b1220;">Expansão Urbana</h3>
                    <p class="text-muted mb-0">Linhas de crédito focadas na aceleração de projetos que impulsionem o desenvolvimento das cidades com alta demanda.</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <h3 class="h5 fw-bold mb-3" style="color: #0b1220;">Controle Financeiro</h3>
                    <p class="text-muted mb-0">Emissão de recebíveis a termo com flexibilidade de cronogramas, reduzindo pressão de caixa no estágio inicial das obras.</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <h3 class="h5 fw-bold mb-3" style="color: #0b1220;">Segurança Jurídica</h3>
                    <p class="text-muted mb-0">Estruturação lastreada em alienação fiduciária dos lotes, aliada a seguros e mecanismos que mitigam riscos à operação.</p>
                </div>
            </div>
        </div>
    </div>
