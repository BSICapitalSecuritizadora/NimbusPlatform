        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <h1 class="display-3 fw-bold mb-4" style="color: #ffffff; letter-spacing: -0.02em;">
                    Auditoria de <br><span style="color: var(--gold);">Acessos</span>
                </h1>
                <p class="lead mb-5" style="color: #a5b4fc; max-width: 90%;">
                    Trilha completa de auditoria para cada ação executada na plataforma. Saiba quem acessou, baixou ou visualizou cada documento, quando e de onde.
                </p>
...
<section class="py-5" style="background-color: var(--bg);">
    <div class="container py-5">
        <div class="text-center mb-5 pb-3">
            <h2 class="h3 fw-bold text-dark mb-3">Rastreabilidade Total</h2>
            <p class="text-muted mx-auto" style="max-width: 600px;">Cada interação no portal é registrada, criando um histórico completo e imutável de ações para fins regulatórios.</p>
        </div>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <h3 class="h5 fw-bold mb-3" style="color: #0b1220;">Logs em Tempo Real</h3>
                    <p class="text-muted mb-0">Registro instantâneo de login, visualização de documentos, downloads e alterações de configuração com timestamp preciso.</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <h3 class="h5 fw-bold mb-3" style="color: #0b1220;">Identificação de Usuário</h3>
                    <p class="text-muted mb-0">Cada ação é vinculada ao usuário autenticado, com informações de IP, dispositivo e localização geográfica.</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <h3 class="h5 fw-bold mb-3" style="color: #0b1220;">Relatórios de Auditoria</h3>
                    <p class="text-muted mb-0">Exportação de relatórios detalhados para atender demandas de auditores, reguladores e comitês de governança.</p>
                </div>
            </div>
        </div>
    </div>
