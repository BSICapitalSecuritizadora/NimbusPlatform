        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <p class="lead mb-5" style="color: #a5b4fc; max-width: 90%;">
                    Registro estruturado das interações realizadas na plataforma para acompanhar acessos, consultas, downloads e eventos relevantes com segurança e rastreabilidade.
                </p>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <h3 class="h5 fw-bold mb-3" style="color: #0b1220;">Eventos registrados</h3>
                    <p class="text-muted mb-0">Login, visualização de documentos, downloads e demais interações relevantes podem ser registrados com marcação temporal e contexto operacional.</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <h3 class="h5 fw-bold mb-3" style="color: #0b1220;">Identificação e contexto</h3>
                    <p class="text-muted mb-0">Os registros podem ser associados ao usuário autenticado e a dados técnicos de contexto para ampliar a confiabilidade da trilha de acesso.</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card card-opea h-100 p-4 border-0 shadow-sm card-hover" style="transition: .3s;">
                    ...
                    <h3 class="h5 fw-bold mb-3" style="color: #0b1220;">Relatórios de controle</h3>
                    <p class="text-muted mb-0">As evidências de acesso podem ser consolidadas para apoiar auditorias, revisões internas, comitês de governança e demandas regulatórias.</p>
                </div>
            </div>
        </div>
    </div>
