...
<section class="py-5">
    <div class="container py-5">
        ...
        <div class="row g-0 position-relative">
            <div class="d-none d-lg-block position-absolute start-0 w-100 border-top border-2" style="top: 30px; border-color: rgba(212,175,55, 0.3) !important; z-index: 1;"></div>
