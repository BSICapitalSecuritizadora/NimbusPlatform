...
@push('head')
<style>
    .careers-page { background: #E6E4E4; color: #091B23; }
    .careers-eyebrow { color: #A06E28; letter-spacing: 0.14em; text-transform: uppercase; font-size: 0.75rem; font-weight: 700; margin-bottom: 0.5rem; }
    .careers-section-title { color: #091B23; }
    .careers-section-text { color: rgba(9, 27, 35, 0.72); line-height: 1.6; }
    .careers-area-card { background: #FFFFFF; border: 1px solid rgba(9, 27, 35, 0.10); border-radius: 16px; box-shadow: 0 14px 34px rgba(9, 27, 35, 0.06); transition: border-color 180ms ease, transform 180ms ease, box-shadow 180ms ease; }
    .careers-area-card:hover { border-color: rgba(160, 110, 40, 0.40); transform: translateY(-2px); box-shadow: 0 18px 40px rgba(9, 27, 35, 0.09); }
    .careers-area-card__icon { color: #A06E28; background: rgba(160, 110, 40, 0.08); border: 1px solid rgba(160, 110, 40, 0.18); width: 32px; height: 32px; border-radius: 8px; display: flex; align-items: center; justify-content: center; }
    .careers-area-card__title { color: #091B23; }
    .careers-area-card__text { color: rgba(9, 27, 35, 0.70); }
    .careers-chip { background: #FFFFFF; border: 1px solid rgba(9, 27, 35, 0.12); color: #091B23; padding: 0.6rem 1.25rem; border-radius: 50rem; font-weight: 500; font-size: 0.9rem; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(0,0,0,0.02); display: inline-block; cursor: default; }
    .careers-chip:hover { background: rgba(160, 110, 40, 0.10); border-color: rgba(160, 110, 40, 0.35); color: #A06E28; transform: translateY(-2px); box-shadow: 0 8px 15px rgba(9, 27, 35, 0.05); }
    .careers-empty-state { background: rgba(255, 255, 255, 0.62); border: 1px dashed rgba(160, 110, 40, 0.35); border-radius: 18px; }
    .careers-dark-card { background: linear-gradient(135deg, #091B23 0%, #0B2029 60%, #091B23 100%); border: 1px solid rgba(160, 110, 40, 0.35); border-radius: 1.5rem; color: #E6E4E4; position: relative; overflow: hidden; }
    .careers-dark-card p { color: rgba(230, 228, 228, 0.72); }
    .careers-light-card { background: #FFFFFF; border: 1px solid rgba(9, 27, 35, 0.10); border-radius: 1.5rem; color: #091B23; }
    .careers-step-badge { width: 32px; height: 32px; border-radius: 50%; background: rgba(160, 110, 40, 0.08); color: #A06E28; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 0.9rem; border: 1px solid rgba(160, 110, 40, 0.18); }
    .careers-filter-bar { background: #FFFFFF; border: 1px solid rgba(9,27,35,0.10); border-radius: 16px; box-shadow: 0 8px 24px rgba(9,27,35,0.06); }
    .careers-filter-bar .form-control, .careers-filter-bar .form-select { border-radius: 0.5rem; border: 1px solid rgba(9,27,35,0.12); }
    .careers-filter-bar .form-control:focus, .careers-filter-bar .form-select:focus { border-color: #A06E28; box-shadow: 0 0 0 0.2rem rgba(160,110,40,0.12); }
</style>
@endpush
    ...
    <div class="container py-lg-4">
        ...
        <div class="row g-4 mb-5 pb-5 border-bottom" style="border-color: rgba(9, 27, 35, 0.08) !important;">
            <div class="col-md-6 col-lg-3">
                <div class="careers-area-card h-100 p-4 d-flex flex-column">
                    <div class="mb-3"><div class="careers-area-card__icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"></path></svg></div></div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="careers-area-card h-100 p-4 d-flex flex-column">
                    <div class="mb-3"><div class="careers-area-card__icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg></div></div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="careers-area-card h-100 p-4 d-flex flex-column">
                    <div class="mb-3"><div class="careers-area-card__icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg></div></div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="careers-area-card h-100 p-4 d-flex flex-column">
                    <div class="mb-3"><div class="careers-area-card__icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg></div></div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="careers-area-card h-100 p-4 d-flex flex-column">
                    <div class="mb-3"><div class="careers-area-card__icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"></rect><line x1="8" y1="21" x2="16" y2="21"></line><line x1="12" y1="17" x2="12" y2="21"></line></svg></div></div>
            ...
            <div class="col-md-12 col-lg-4">
                <div class="careers-area-card h-100 p-4 d-flex flex-column">
                    <div class="mb-3"><div class="careers-area-card__icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path></svg></div></div>
        ...
        <div class="row g-4 align-items-end mb-3">
            <div class="col-lg-8">
                ...
                <p class="small careers-section-text mb-0">{{ $vacancies->total() }} vaga(s) encontrada(s)@if($hasFilters) com os filtros atuais @endif</p>
            </div>
        </div>

        <!-- Filters -->
        <div class="careers-filter-bar p-3 p-lg-4 mb-4">
            <form method="GET" action="{{ route('site.vacancies.index') }}" class="row g-3 align-items-end">
                <div class="col-md-4">
                    <label for="filter_q" class="form-label small fw-semibold text-muted">Buscar por título</label>
                    <input id="filter_q" type="text" name="q" value="{{ $filters['q'] ?? '' }}" class="form-control" placeholder="Ex: Analista de Operações">
                </div>
                <div class="col-md-2">
                    <label for="filter_department" class="form-label small fw-semibold text-muted">Área</label>
                    <select id="filter_department" name="department" class="form-select">
                        <option value="">Todas</option>
                        @foreach($departments as $val => $label)
                            <option value="{{ $val }}" @selected(($filters['department'] ?? null) === $val)>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-2">
                    <label for="filter_type" class="form-label small fw-semibold text-muted">Contratação</label>
                ...
                <div class="col-md-2">
                    <label for="filter_work_model" class="form-label small fw-semibold text-muted">Modelo</label>
                    <select id="filter_work_model" name="work_model" class="form-select">
                        <option value="">Todos</option>
                        @foreach($workModels as $val => $label)
                            <option value="{{ $val }}" @selected(($filters['work_model'] ?? null) === $val)>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-2 d-flex gap-2">
                    <button type="submit" class="btn flex-fill" style="background:#091B23;color:#E6E4E4;border-radius:0.5rem;">Filtrar</button>
                    @if($hasFilters)
                        <a href="{{ route('site.vacancies.index') }}" class="btn btn-outline-secondary flex-fill" style="border-radius:0.5rem;">Limpar</a>
                    @endif
                </div>
            </form>
        </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="careers-area-card h-100 d-flex flex-column border-0" style="padding: 1px;">
                        <div class="card-body p-4 d-flex flex-column bg-white" style="border-radius: 15px;">
                            ...
                            <h3 class="h4 fw-bold mb-2 careers-area-card__title">{{ $vacancy->title }}</h3>
                            <div class="d-flex flex-wrap gap-2 small mb-3 careers-section-text">
                                <span class="d-inline-flex align-items-center gap-1"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg> {{ $vacancy->location }}</span>
                                @if($vacancy->work_model)
                                    <span class="d-inline-flex align-items-center gap-1">· {{ \App\Enums\VacancyWorkModel::labelFor($vacancy->work_model) }}</span>
                                @endif
                                @if($vacancy->positions > 1)
                                    <span class="d-inline-flex align-items-center gap-1">· {{ $vacancy->positions }} vagas</span>
                                @endif
                            </div>
                            @if($vacancy->salary_visible && $vacancy->salaryRangeLabel())
                                <div class="small fw-semibold mb-3" style="color:#A06E28;">{{ $vacancy->salaryRangeLabel() }}</div>
                            @endif
                            <div class="mt-auto">
            ...
            @empty
                <div class="col-12">
                    <div class="careers-empty-state p-5 text-center">
                        ...
                        @if($hasFilters)
                            <h4 class="h4 fw-bold mb-3" style="color: #091B23;">Nenhuma vaga encontrada com os filtros atuais</h4>
                            <p class="mx-auto mb-4" style="max-width: 500px; font-size: 1.05rem; line-height: 1.6; color: rgba(9, 27, 35, 0.68);">
                                Tente ajustar os filtros ou limpar a busca para ver todas as oportunidades disponíveis.
                            </p>
                            <div class="d-flex justify-content-center">
                                <a href="{{ route('site.vacancies.index') }}" class="btn btn-lg px-5" style="background: #091B23; color: #E6E4E4; border: none; border-radius: 0.5rem;">Limpar filtros</a>
                            </div>
                        @else
                            ...
                            <div class="d-flex justify-content-center">
                                <a href="mailto:contato@bsicapital.com.br" class="btn btn-lg px-5" style="background: #091B23; color: #E6E4E4; border: none; border-radius: 0.5rem; box-shadow: 0 4px 15px rgba(9,27,35,0.15);">Cadastrar currículo</a>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="careers-dark-card h-100 p-4 p-lg-5 d-flex flex-column">
                    ...
                    <div class="mt-auto position-relative z-1">
                        <a href="mailto:contato@bsicapital.com.br" class="btn" style="background: #E6E4E4; color: #091B23; padding: 0.75rem 1.5rem; border-radius: 0.5rem;">Cadastrar currículo</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="careers-light-card h-100 p-4 p-lg-5 d-flex flex-column">
                    ...
                    <div class="d-flex flex-column gap-4">
                        <div class="d-flex align-items-center gap-3"><div class="careers-step-badge">1</div><div><span class="fw-semibold d-block" style="font-size: 1.05rem; color: #091B23;">Cadastro ou envio do currículo</span></div></div>
                        <div class="d-flex align-items-center gap-3"><div class="careers-step-badge">2</div><div><span class="fw-semibold d-block" style="font-size: 1.05rem; color: #091B23;">Triagem curricular</span></div></div>
                        <div class="d-flex align-items-center gap-3"><div class="careers-step-badge">3</div><div><span class="fw-semibold d-block" style="font-size: 1.05rem; color: #091B23;">Conversas técnicas e comportamentais</span></div></div>
                        <div class="d-flex align-items-center gap-3"><div class="careers-step-badge">4</div><div><span class="fw-semibold d-block" style="font-size: 1.05rem; color: #091B23;">Avaliação final e retorno</span></div></div>
                    </div>
