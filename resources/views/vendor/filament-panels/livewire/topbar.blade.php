    ...
    >
        ...
        @if ($hasNavigation)
            <x-filament::icon-button
                ...
                icon-size="lg"
                :label="__('Expandir menu')"
                x-cloak
                x-data="{ tooltip: { content: 'Expandir menu', placement: 'bottom' } }"
            ...
            <x-filament::icon-button
                ...
                icon-size="lg"
                :label="__('Recolher menu')"
                x-cloak
                x-data="{ tooltip: { content: 'Recolher menu', placement: 'bottom' } }"
                x-tooltip.html="tooltip"
                aria-controls="fi-main-sidebar"
                x-bind:aria-expanded="$store.sidebar.isOpen"
