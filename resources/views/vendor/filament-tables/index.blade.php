                        ...
                        <div>
                            ...
                            @if ($hasFiltersTrigger || $hasColumnManager)
                                ...
                                @if ($hasFiltersDialog)
                                    ...
                                    @else
                                        {{-- BSI override (filament/tables v5.7.6): teleport + flip + size para o painel de filtros nunca ser cortado pelo card/tabela/viewport. --}}
                                        <x-filament::dropdown
                                ...
                                @if ($hasColumnManager)
                                    ...
                                    @else
                                        {{-- BSI override (filament/tables v5.7.6): teleport + flip + size para o painel de colunas nunca ser cortado pelo card/tabela/viewport. --}}
                                        <x-filament::dropdown
