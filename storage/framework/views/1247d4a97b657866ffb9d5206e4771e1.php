...
<body class="nd-portal-login">
    ...
    <div class="nd-portal-card">
        ...
        <!-- Form -->
        <form method="post" action="<?php echo e(route('nimbus.auth.verify.post')); ?>" autocomplete="off">
            <?php echo csrf_field(); ?>
...
<?php /**PATH /home/desktop/projects/bsi-capital/resources/views/nimbus/auth/login.blade.php ENDPATH**/ ?>