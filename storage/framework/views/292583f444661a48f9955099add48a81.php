                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card h-100 border-0 shadow-sm emission-card overflow-hidden">
                        ...
                        <div class="card-body p-3 p-lg-4">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($e->documents->isNotEmpty()): ?>
                            <div class="border-top pt-3">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($termo): ?>
                                        <a href="<?php echo e(route('site.documents.download', $termo->id)); ?>" class="d-flex align-items-center gap-2 text-decoration-none py-1" style="color: var(--brand); font-size: 0.85rem;">
                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                                            <span class="fw-medium text-truncate">Termo de Securitização</span>
                                        </a>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($relatorio): ?>
                                        <a href="<?php echo e(route('site.documents.download', $relatorio->id)); ?>" class="d-flex align-items-center gap-2 text-decoration-none py-1" style="color: var(--brand); font-size: 0.85rem;">
                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                        ...
                        <div class="card-footer bg-transparent border-0 p-3 p-lg-4 pt-0 d-grid">
                            <a href="<?php echo e(route('site.emissions.show', $e->if_code)); ?>" class="btn btn-outline-brand btn-sm w-100">Consultar Operação Completa</a>
                        </div>
                    </div>
                </div>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2581014250-0', $__key);
        ...
        <div class="row g-5">
            <div class="col-lg-4">
                <div class="pe-lg-4">
                    ...
                    <a href="<?php echo e(route('site.contact')); ?>" class="btn btn-brand btn-sm px-4 py-2">Falar com um especialista</a>
                </div>
            </div>
            <div class="col-lg-8">
...
<?php echo $__env->make('site.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/desktop/projects/bsi-capital/resources/views/site/imobiliario/cri.blade.php ENDPATH**/ ?>