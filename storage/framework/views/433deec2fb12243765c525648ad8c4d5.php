<?php $__env->startSection('title','Sobre — BSI Capital'); ?>

<?php $__env->startSection('content'); ?>
<!-- Hero Section -->
<section class="hero position-relative d-flex align-items-center" style="min-height: 60vh; overflow: hidden; background: var(--brand-strong);">
    <div class="position-absolute top-0 start-0 w-100 h-100" style="opacity: 0.08; background: url('<?php echo e(asset('images/compliance.png')); ?>') center/cover; mix-blend-mode: luminosity;"></div>
            ...
            <div class="col-lg-6 d-none d-lg-block">
                <div class="position-relative">
                    <div style="border-radius: 20px; overflow: hidden; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.5);">
                        <img src="<?php echo e(asset('images/compliance.png')); ?>" class="img-fluid" alt="BSI Capital Securitizadora" style="width: 100%; height: 500px; object-fit: cover;">
                    </div>
    ...
    <div class="container py-5">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 order-lg-2">
                <div class="position-relative">
                    <img src="<?php echo e(asset('images/compliance.png')); ?>" class="img-fluid rounded-4 shadow-lg" alt="Tecnologia BSI" style="filter: grayscale(20%); width: 100%; height: 400px; object-fit: cover;">
                </div>
            </div>
