                    ...
                    <div class="dropdown-menu mega-menu p-0 border-0">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-4 p-3">
                                ...
                                <a class="mega-link" href="<?php echo e(route('site.servicos.compliance')); ?>">Compliance</a>
                            </div>
    ...
    <div class="container">
        <div class="row gy-4 align-items-center">
            <div class="col-md-4 text-center text-md-start">
                <a class="navbar-brand fw-bold mb-3 d-inline-block" href="<?php echo e(route('site.home')); ?>">
                    <img src="<?php echo e(asset('images/logo-mob.png')); ?>" alt="BSI Capital" style="max-height: 48px;">
                </a>
                ...
                <div class="row g-4">
                    <div class="col-6 col-sm-6">
                        ...
                        <div class="d-flex flex-column gap-2 fw-medium">
                            <a href="<?php echo e(route('site.emissions')); ?>" class="footer-link">Ver Emissões</a>
                            <a href="<?php echo e(route('site.ri')); ?>" class="footer-link">Rel. com Investidores</a>
                            <a href="<?php echo e(route('proposal.create')); ?>" class="footer-link">Envie sua proposta</a>
                            <a href="<?php echo e(route('site.vacancies.index')); ?>" class="footer-link">Trabalhe conosco</a>
                        </div>
                    </div>
                    <div class="col-6 col-sm-6">
                        <div class="footer-heading">Conformidade</div>
                        <div class="d-flex flex-column gap-2 fw-medium">
                            <a href="<?php echo e(route('site.compliance')); ?>" class="footer-link">Canal de Ética</a>
                            <a href="<?php echo e(route('site.contact')); ?>" class="footer-link">Ouvidoria</a>
                            <a href="<?php echo e(route('site.governance')); ?>" class="footer-link">Governança</a>
                            <a href="<?php echo e(route('site.compliance')); ?>" class="footer-link">Compliance</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 text-center text-md-end">
                <div class="footer-seal">
                    ...
                    <img src="<?php echo e(asset('images/selo-anbima.jpg')); ?>" class="img-fluid" alt="Selo ANBIMA Securitizadora" style="max-height: 84px; border-radius: 6px;">
                </div>
            </div>
        </div>
        ...
        <div class="text-center small pb-2">
            <div class="text-muted mb-1">
                © <?php echo e(date('Y')); ?> BSI Capital Securitizadora S.A. Todos os direitos reservados.
            </div>
            <div class="d-flex flex-wrap justify-content-center gap-2 align-items-center">
                <a href="<?php echo e(route('site.privacy-policy')); ?>" class="footer-legal-link">Política de Privacidade</a>
                <span class="text-muted opacity-50">•</span>
                <a href="<?php echo e(route('site.terms-of-use')); ?>" class="footer-legal-link">Termos de Uso</a>
                <span class="text-muted opacity-50">•</span>
                <a href="<?php echo e(route('site.compliance')); ?>" class="footer-legal-link" style="color: var(--gold);">Canal de Ética</a>
                <span class="text-muted opacity-50">•</span>
                <a href="<?php echo e(route('site.contact')); ?>" class="footer-legal-link" style="color: var(--gold);">Ouvidoria</a>
            </div>
        </div>
    </div>
</footer>
...
<?php /**PATH /var/www/html/resources/views/site/layout.blade.php ENDPATH**/ ?>