<?php # [BlazeFolded]:{flux::icon.archive-box}:{/home/desktop/projects/bsi-capital/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/archive-box.blade.php}:{1771950596} ?>
...
<?php # [BlazeFolded]:{flux::icon.check-circle}:{/home/desktop/projects/bsi-capital/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/check-circle.blade.php}:{1771950596} ?>
...
?>
    ...
    <div class="mb-6 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div class="nd-meta-chip nd-meta-chip-muted">Última atualização · <?php echo e($portalNow->format('d.m.Y · H:i')); ?></div>
    </div>
        ...
        <div class="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between lg:gap-10 lg:pl-8">
            <div class="flex-1">
                ...
                <h1 class="font-fraunces text-[30px] font-normal text-white leading-tight mb-3">
                    <?php echo e($greeting); ?>, <?php echo e($firstName); ?>.<br>
                ...
                <div class="mt-6 flex flex-wrap gap-3">
                    <div class="welcome-chip">
                        <span class="welcome-chip-value"><?php echo e(sprintf('%02d', $pendingSubmissions)); ?></span>
                        <span>em acompanhamento</span>
                    </div>
                    <div class="welcome-chip">
                        <span class="welcome-chip-value"><?php echo e($closedRate); ?>%</span>
                        <span>encerrados</span>
                    </div>
                    <div class="welcome-chip">
                        <span class="welcome-chip-value"><?php echo e($latestActivity); ?></span>
            ...
            <div class="flex w-full flex-col gap-4 lg:max-w-[320px]">
                <div class="font-jetbrains text-[10.5px] text-white/50 tracking-widest uppercase lg:text-right">
                    Sessão ativa · <?php echo e($portalNow->translatedFormat('d M Y · H:i')); ?> BRT
                </div>
                <a href="<?php echo e(route('nimbus.submissions.create')); ?>" class="p-btn-primary flex items-center justify-between h-[48px] px-6 bg-gold-500 border border-gold-600 rounded-[4px] text-white text-[14px] font-semibold no-underline shadow-lg transition-all hover:bg-gold-400 hover:text-white">
                ...
                <div class="welcome-aside">
                    <div class="flex items-start justify-between gap-4">
                        <div>
                            ...
                            <div class="mt-1 font-inter text-[14px] font-semibold text-white"><?php echo e($pendingSummary); ?></div>
                        </div>
                    ...
                    <div class="mt-4 grid gap-3">
                        <div class="welcome-aside-row">
                            ...
                            <strong><?php echo e($latestProtocol ?? 'Sem protocolo'); ?></strong>
                        </div>
                        <div class="welcome-aside-row">
                            <span>Registros visíveis</span>
                            <strong><?php echo e(sprintf('%02d', $visibleSubmissions)); ?></strong>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="kpi gold shadow-portal-subtle">
            <div class="flex items-start justify-between mb-4">
                ...
                <div class="w-7 h-7 bg-ink-50 rounded-[6px] flex items-center justify-center text-ink-500">
                    <svg class="shrink-0 [:where(&amp;)]:size-6 size-[18px]" stroke-width="1.6" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
  <path stroke-linecap="round" stroke-linejoin="round" d="m20.25 7.5-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125Z"/>
            ...
            <div class="flex items-baseline gap-2 mb-6">
                <div class="font-fraunces text-[42px] font-medium tracking-tight text-navy-900 leading-none"><?php echo e(sprintf('%02d', $totalSubmissions)); ?></div>
                <div class="font-inter text-[13px] font-medium text-ink-400">total</div>
            </div>
            <div class="kpi-meta font-inter text-[12px] text-ink-500">
                <?php echo e($totalSubmissions > 0 ? 'Visão rápida com '.sprintf('%02d', $visibleSubmissions).' registros recentes' : 'Pronto para iniciar sua primeira solicitação'); ?>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
            ...
            <div class="flex items-baseline gap-2 mb-6">
                <div class="font-fraunces text-[42px] font-medium tracking-tight text-navy-900 leading-none"><?php echo e(sprintf('%02d', $pendingSubmissions)); ?></div>
                <div class="font-inter text-[13px] font-medium text-ink-400">em curso</div>
            </div>
            <div class="kpi-meta font-inter text-[12px] text-ink-500">
                <?php echo e($pendingSummary); ?>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
            ...
            <div class="flex items-baseline gap-2 mb-6">
                <div class="font-fraunces text-[42px] font-medium tracking-tight text-navy-900 leading-none"><?php echo e(sprintf('%02d', $closedSubmissions)); ?></div>
                <div class="font-inter text-[13px] font-medium text-ink-400">do histórico</div>
            </div>
            <div class="kpi-meta font-inter text-[12px] text-ink-500">
                <?php echo e($closedSummary); ?>
        ...
        <div class="px-7 py-6 border-b border-ink-100 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
                ...
                <div class="font-jetbrains text-[11px] uppercase tracking-[.1em] text-ink-400">
                    Atualizado em tempo real · <?php echo e($visibleSubmissions); ?> registros visíveis
                </div>
            </div>
            <div class="filterbar flex items-center gap-3">
                <div class="nd-meta-chip nd-meta-chip-muted">Visão rápida · <?php echo e($visibleSubmissions); ?> itens</div>
                <a href="<?php echo e(route('nimbus.submissions.index')); ?>" class="flex items-center justify-center px-[14px] py-[8px] bg-white border border-ink-200 rounded-[5px] text-ink-700 text-[13px] font-medium no-underline hover:bg-ink-50 transition-colors">
                    Ver todas
                </a>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($submissions->isEmpty()): ?>
                <div class="nd-empty-state py-12 text-center">
                    ...
                    <a href="<?php echo e(route('nimbus.submissions.create')); ?>" class="inline-flex items-center justify-center gap-2 rounded-[5px] border border-gold-600 bg-gold-500 px-5 py-2.5 text-[13px] font-semibold text-[#1A1305] no-underline transition-all hover:bg-gold-400">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            ...
                            <tr class="border-b border-ink-100 hover:bg-[#FAFBFD] transition-colors">
                                <td class="px-7 py-[18px]">
                                    <div class="font-jetbrains text-[13px] font-medium text-navy-900 uppercase">#<?php echo e($protocol); ?></div>
                                    <div class="font-inter text-[12px] text-ink-500"><?php echo e($s->company_name ?? 'Sem razão social informada'); ?></div>
                                </td>
                                <td class="px-7 py-[18px]">
                                    <div class="font-inter text-[13px] font-medium text-navy-900"><?php echo e($s->title ?? 'Solicitação enviada'); ?></div>
                                    <div class="font-inter text-[12px] text-ink-500"><?php echo e($submissionType); ?></div>
                                </td>
                                <td class="px-7 py-[18px]">
                                    <div class="font-jetbrains text-[13px] text-navy-900"><?php echo e($submissionTimestamp?->format('d / m / Y') ?? '—'); ?></div>
                                    <div class="font-inter text-[11.5px] text-ink-400"><?php echo e($submissionTimestamp?->format('H:i') ?? 'Sem horário'); ?> · São Paulo</div>
                                </td>
                                <td class="px-7 py-[18px] text-right font-jetbrains text-[13.5px] font-medium text-navy-900">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($s->annual_revenue !== null): ?>
                                        R$ <?php echo e(number_format((float) $s->annual_revenue, 2, ',', '.')); ?>
...
<?php echo $__env->make('nimbus.layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/desktop/projects/bsi-capital/resources/views/nimbus/dashboard.blade.php ENDPATH**/ ?>