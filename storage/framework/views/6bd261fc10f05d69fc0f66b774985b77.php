            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-white/10 text-sm">
                    ...
                    <tbody class="divide-y divide-white/10">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr class="align-top text-gray-200">
                                <td class="px-4 py-4">
                                    <div class="font-medium text-white"><?php echo e($row['reference_month_label']); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($row['missing_sources']) > 0): ?>
                                        <div class="mt-1 text-xs text-amber-200">
                                            Pendente: <?php echo e(implode(', ', $row['missing_sources'])); ?>

                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="px-4 py-4"><?php echo e($formatCurrency($row['quota_value'])); ?></td>
                                <td class="px-4 py-4"><?php echo e($formatCurrency($row['units_value'])); ?></td>
                                <td class="px-4 py-4"><?php echo e($formatCurrency($row['receivables_value'])); ?></td>
                                <td class="px-4 py-4"><?php echo e($formatCurrency($row['account_balance_value'])); ?></td>
                                <td class="px-4 py-4"><?php echo e($formatCurrency($row['outstanding_balance_value'])); ?></td>
                                <td class="px-4 py-4">
                                    <div class="font-medium text-white"><?php echo e($formatRatio($row['coverage_ratio'])); ?></div>
                                    <div class="mt-1 text-xs text-gray-400">Total: <?php echo e($formatCurrency($row['total_guarantees_value'])); ?></div>
                                </td>
                            </tr>
...
<?php /**PATH /home/desktop/projects/bsi-capital/resources/views/filament/resources/emissions/relation-managers/guarantees-history.blade.php ENDPATH**/ ?>