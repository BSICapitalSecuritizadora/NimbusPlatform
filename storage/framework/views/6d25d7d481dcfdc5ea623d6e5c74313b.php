...
<body style="margin:0;padding:0;background:#ece9e8;font-family:Arial,Helvetica,sans-serif;color:#1f2937;">
    <div style="max-width:640px;margin:0 auto;padding:32px 20px;">
        ...
        <div style="background:#f7f5f4;border:1px solid #cdd1d2;border-top:0;border-radius:0 0 16px 16px;padding:32px;">
            ...
            <p>Informamos que o saldo do fundo vinculado a emissao <strong><?php echo e($fund->emission?->name ?? 'Nao informada'); ?></strong> esta abaixo do valor minimo cadastrado.</p>
            ...
            <div style="background:#f2efee;border:1px solid #d7e0e3;border-radius:12px;padding:20px;margin:24px 0;">
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;font-size:14px;">
                    <tr>
                        ...
                        <td style="padding:8px 0;font-weight:600;"><?php echo e($fund->emission?->name ?? 'Nao informada'); ?></td>
                    </tr>
                    <tr>
                        <td style="padding:8px 0;color:#6b7280;">Numero da conta</td>
                        <td style="padding:8px 0;font-weight:600;">Conta <?php echo e($fund->account); ?></td>
                    </tr>
                    <tr>
                        <td style="padding:8px 0;color:#6b7280;">Saldo atual</td>
                        <td style="padding:8px 0;font-weight:600;">R$ <?php echo e(\App\Concerns\MoneyFormatter::formatCurrencyForDisplay($fund->balance)); ?></td>
                    </tr>
                    <tr>
                        <td style="padding:8px 0;color:#6b7280;">Valor minimo cadastrado</td>
                        <td style="padding:8px 0;font-weight:600;">R$ <?php echo e(\App\Concerns\MoneyFormatter::formatCurrencyForDisplay($fund->minimum_balance)); ?></td>
                    </tr>
                    <tr>
                        <td style="padding:8px 0;color:#6b7280;">Data e hora da verificacao</td>
                        <td style="padding:8px 0;font-weight:600;"><?php echo e($checkedAt->format('d/m/Y H:i')); ?></td>
                    </tr>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($fund->emission?->description)): ?>
                        <tr>
                            <td style="padding:8px 0;color:#6b7280;vertical-align:top;">Observacao</td>
                            <td style="padding:8px 0;font-weight:600;"><?php echo e($fund->emission->description); ?></td>
                        </tr>
...
<?php /**PATH /home/desktop/projects/bsi-capital/resources/views/emails/funds/balance-below-minimum.blade.php ENDPATH**/ ?>