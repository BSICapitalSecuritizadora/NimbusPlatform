            ...
            <div class="col-lg-6 d-none d-lg-block">
                <div class="position-relative">
                    ...
                    <div class="position-absolute bg-white px-4 py-3 rounded-4 shadow-lg d-flex align-items-center gap-3" style="bottom: -20px; left: -30px; animation: float 6s ease-in-out infinite;">
                        ...
                        <div>
                            <div class="text-muted small fw-medium">Governança corporativa</div>
                            <div class="fw-bold fs-5" style="color: #0b1220;">Comitê independente</div>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('site.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/desktop/projects/bsi-capital/resources/views/site/governance.blade.php ENDPATH**/ ?>