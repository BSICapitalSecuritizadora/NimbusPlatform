                    ...
                    <div class="p-4">
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-end" style="height: 100px; gap: 8px;">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [30, 45, 25, 60, 80, 40, 55, 90, 35, 50, 75, 65]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $height): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <div class="bg-brand-subtle rounded-top w-100" style="height: <?php echo e($height); ?>%; opacity: 0.6; transition: all 0.3s ease;" onmouseover="this.style.opacity='1'; this.style.backgroundColor='var(--gold)'" onmouseout="this.style.opacity='0.6'; this.style.backgroundColor='var(--brand-subtle)'"></div>
...
<?php echo $__env->make('site.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/site/servicos/auditoria-acessos.blade.php ENDPATH**/ ?>