<?php $__env->startSection('title', 'Serviços — BSI Capital'); ?>
...
<section class="py-5">
    <div class="container py-4">
        ...
        <div class="row g-4">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$title, $description, $link]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <div class="col-md-6 col-xl-4">
                    <div class="card h-100 p-4 p-lg-5 border-0 shadow-sm card-hover">
                        <div class="section-kicker mb-2">Frente de atuação</div>
                        <h3 class="h3 fw-bold text-brand mb-3"><?php echo e($title); ?></h3>
                        <p class="section-copy mb-4"><?php echo e($description); ?></p>
                        <div class="mt-auto">
                            <a href="<?php echo e($link); ?>" class="btn btn-outline-brand px-4">Acessar área</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="card border-0 overflow-hidden" style="background: linear-gradient(135deg, var(--brand-strong), #0b1f4f);">
            <div class="row g-0 align-items-center">
                ...
                <div class="col-lg-4">
                    <div class="p-4 p-lg-5">
                        <a href="<?php echo e(route('site.contact')); ?>" class="btn btn-light btn-lg">Falar com a equipe</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('site.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/desktop/projects/bsi-capital/resources/views/site/service.blade.php ENDPATH**/ ?>