...
<head>
    <meta charset="UTF-8">
    <title>BSI Capital Securitizadora — <?php echo $__env->yieldContent('title', 'Portal'); ?></title>
        ...
        <div class="container-xxl p-0 relative">
            <div class="flex items-center w-full px-4 h-[72px]">
                ...
                <div class="flex items-center h-full pr-6 border-r border-white/5">
                    <a class="flex items-center no-underline" href="<?php echo e(route('nimbus.dashboard')); ?>">
                        <img
                            src="<?php echo e(asset('images/bsi-capital-logo.png')); ?>"
                ...
                <div class="p-nav flex-1 flex items-center h-full px-6">
                    <ul class="flex items-center gap-2 m-0 p-0 list-none h-full">
                        <li class="h-full">
                            <a class="flex items-center gap-2 px-4 h-full text-[13.5px] font-medium transition-all no-underline <?php echo e(request()->routeIs('nimbus.dashboard') ? 'text-white border-b-2 border-gold-500' : 'text-white/60 hover:text-white'); ?>" href="<?php echo e(route('nimbus.dashboard')); ?>">
                                <i class="bi bi-house text-[14px]"></i>
                                <span>Início</span>
                            </a>
                        </li>
                        <li class="h-full">
                            <a class="flex items-center gap-2 px-4 h-full text-[13.5px] font-medium transition-all no-underline <?php echo e($isSubmissions && !request()->routeIs('nimbus.dashboard') ? 'text-white border-b-2 border-gold-500' : 'text-white/60 hover:text-white'); ?>" href="<?php echo e(route('nimbus.submissions.index')); ?>">
                                <i class="bi bi-inbox text-[14px]"></i>
                                <span>Meus Envios</span>
                            </a>
                        </li>
                        <li class="h-full">
                             <a class="flex items-center gap-2 px-4 h-full text-[13.5px] font-medium transition-all no-underline <?php echo e($isDocuments ? 'text-white border-b-2 border-gold-500' : 'text-white/60 hover:text-white'); ?>" href="<?php echo e(route('nimbus.documents.index')); ?>">
                ...
                <div class="flex items-center gap-6 h-full pl-6 border-l border-white/5">
                    <a class="p-btn-primary flex items-center justify-center h-[38px] px-[18px] bg-gold-500 border border-gold-600 rounded-[4px] text-white text-[13.5px] font-semibold no-underline shadow-[inset_0_1px_0_rgba(255,255,255,0.18)] transition-all hover:bg-gold-400 hover:text-white" href="<?php echo e(route('nimbus.submissions.create')); ?>">
                        ...
                        <div class="p-user dropdown h-full">
                            <button type="button" class="flex items-center h-full gap-3 text-white no-underline border-0 p-0 shadow-none bg-transparent"
                               data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="avatar w-8 h-8 rounded-full bg-gradient-to-b from-[#22424c] to-[#091b23] border border-[rgba(160,110,40,0.6)] flex items-center justify-center text-[#b4864a] text-xs font-semibold">
                                    <?php echo e(strtoupper(substr($user->full_name ?? 'U', 0, 1))); ?><?php echo e(strtoupper(substr(explode(' ', $user->full_name ?? 'U')[1] ?? '', 0, 1))); ?>

                                </div>
                                <div class="flex flex-col items-start leading-tight d-none d-lg-flex">
                                    <span class="text-white text-[13px] font-medium"><?php echo e($user->full_name ?? $user->email); ?></span>
                                </div>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 mt-2 p-0 rounded-[8px] overflow-hidden">
                                <li class="p-3 bg-ink-50 border-b border-ink-100">
                                    <strong class="d-block text-ink-900 text-[13px] text-truncate"><?php echo e($user->full_name); ?></strong>
                                    <small class="text-ink-500 d-block text-[11px] text-truncate"><?php echo e($user->email); ?></small>
                                </li>
                                <li class="p-1">
                                    <form method="POST" action="<?php echo e(route('nimbus.auth.logout')); ?>">
                                        <?php echo csrf_field(); ?>
        ...
        <div class="container-xxl">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error') || $errors->any()): ?>
                <div class="alert alert-danger shadow-sm rounded-[4px] border border-rose-600/18 bg-rose-50 text-rose-600 font-medium mb-4">
                    <i class="bi bi-x-circle-fill me-2"></i> <?php echo e(session('error') ?? $errors->first()); ?>
        ...
        <div class="container-xxl">
            <div class="text-center">
                <p class="mb-0 text-ink-400 font-inter text-[12.5px] font-medium">
                    &copy; <?php echo e(date('Y')); ?> BSI Capital Securitizadora S/A. Todos os direitos reservados.
                </p>
            </div>
        </div>
    </footer>
...
<?php /**PATH /home/desktop/projects/bsi-capital/resources/views/nimbus/layouts/portal.blade.php ENDPATH**/ ?>