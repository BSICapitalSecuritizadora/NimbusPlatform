...
<section class="hero position-relative d-flex align-items-center" style="min-height: 60vh; overflow: hidden; background: var(--brand-strong);">
    <div class="position-absolute top-0 start-0 w-100 h-100" style="opacity: 0.15; background: url('<?php echo e(asset('images/recebiveis_empresas.png')); ?>') center/cover; mix-blend-mode: luminosity;"></div>
            ...
            <div class="col-lg-6 d-none d-lg-block">
                <div class="position-relative">
                    <div style="border-radius: 20px; overflow: hidden; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.5);">
                        <img src="<?php echo e(asset('images/recebiveis_empresas.png')); ?>" class="img-fluid" alt="Recebíveis Corporativos" style="width: 100%; height: 500px; object-fit: cover;">
                    </div>
...
<section class="py-5" style="background-color: var(--bg);">
    <div class="container py-5">
        <div class="text-center mb-5 pb-3">
            <h2 class="h3 fw-bold text-dark mb-3">Três pilares de uma operação de recebíveis bem estruturada</h2>
    ...
    <div class="container py-5">
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-6 order-lg-1">
                <div style="background: url('<?php echo e(asset('images/recebiveis_empresas.png')); ?>') center/cover; height: 400px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);"></div>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-5">
                <a href="<?php echo e(route('site.infra.cr')); ?>" class="card card-opea h-100 p-4 border-0 shadow-sm card-hover text-decoration-none" style="transition: .3s;">
                    ...
                    <h3 class="h5 fw-bold mb-2" style="color: #0b1220;">CR (futuro)</h3>
            ...
            <div class="col-md-5">
                <a href="<?php echo e(route('site.infra.estruturacao')); ?>" class="card card-opea h-100 p-4 border-0 shadow-sm card-hover text-decoration-none" style="transition: .3s;">
                    <div class="mb-4 d-inline-flex align-items-center justify-content-center bg-light rounded-circle" style="width: 60px; height: 60px; color: var(--brand);">
...
<?php echo $__env->make('site.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/desktop/projects/bsi-capital/resources/views/site/infra-empresas/recebiveis.blade.php ENDPATH**/ ?>