<?php $__env->startSection('title', 'Biblioteca de Arquivos'); ?>
...
<div class="mb-8">
    <div class="mb-8 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div class="font-jetbrains text-[11px] uppercase tracking-[.1em] text-ink-400">
            <?php echo e(sprintf('%02d', $generalDocumentsCount)); ?> públicos · <?php echo e(sprintf('%02d', $privateDocumentsCount)); ?> privados · <?php echo e(sprintf('%02d', $categoryCount)); ?> categorias
        </div>
    </div>
    ...
    <div class="mb-8 overflow-hidden rounded-[8px] border border-ink-200 bg-white shadow-portal-subtle">
        <div class="grid grid-cols-1 divide-y divide-ink-100 md:grid-cols-2 md:divide-x md:divide-y-0 xl:grid-cols-4">
            <div class="p-6">
                ...
                <div class="font-fraunces text-[28px] font-medium leading-none text-navy-900"><?php echo e(sprintf('%02d', $generalDocumentsCount)); ?></div>
            ...
            <div class="p-6">
                ...
                <div class="font-fraunces text-[28px] font-medium leading-none text-navy-900"><?php echo e(sprintf('%02d', $privateDocumentsCount)); ?></div>
            ...
            <div class="p-6">
                ...
                <div class="font-fraunces text-[28px] font-medium leading-none text-navy-900"><?php echo e(sprintf('%02d', $categoryCount)); ?></div>
                <div class="font-inter mt-3 text-[12px] text-ink-500"><?php echo e(sprintf('%02d', $cataloguedDocumentsCount)); ?> arquivos públicos catalogados.</div>
            </div>
            <div class="p-6">
                <div class="font-inter mb-2 text-[11px] font-semibold uppercase tracking-[.12em] text-ink-400">Foco Atual</div>
                <div class="font-fraunces text-[22px] font-medium leading-snug text-navy-900"><?php echo e($selectedCategory?->name ?? 'Acervo completo'); ?></div>
                <div class="font-inter mt-3 text-[12px] text-ink-500">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($term)): ?>
                        Busca ativa por "<?php echo e($term); ?>"
                    <?php elseif($activeFiltersCount > 0): ?>
        ...
        <div class="col-xl-3 col-lg-4">
            <div class="sticky-top" style="top: 2rem; z-index: 10;">
                <div class="doc-sidebar-panel">
                    ...
                    <form action="<?php echo e(route('nimbus.documents.index')); ?>" method="get" class="space-y-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($currentCategory)): ?>
                            <input type="hidden" name="category_id" value="<?php echo e($currentCategory); ?>">
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <div class="flex flex-col gap-1.5">
                                <a
                                    href="<?php echo e(route('nimbus.documents.index', ['q' => $term])); ?>"
                                    class="doc-filter-link <?php echo e(empty($currentCategory) ? 'is-active' : ''); ?>"
                                >
                                    <span>Todas</span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($currentCategory)): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    ...
                                    ?>
                                    <a
                                        href="<?php echo e(route('nimbus.documents.index', ['category_id' => $category->id, 'q' => $term])); ?>"
                                        class="doc-filter-link <?php echo e($isActiveCategory ? 'is-active' : ''); ?>"
                                    >
                                        <span class="truncate"><?php echo e($category->name); ?></span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isActiveCategory): ?>
                                            <i class="bi bi-check-lg text-[12px]"></i>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </a>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeFiltersCount > 0): ?>
                            <div class="rounded-[8px] border border-gold-200 bg-gold-50 p-4">
                                ...
                                <div class="mt-3 flex flex-wrap gap-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($term)): ?>
                                        <span class="doc-token">Busca · <?php echo e($term); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedCategory): ?>
                                        <span class="doc-token">Categoria · <?php echo e($selectedCategory->name); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeFiltersCount > 0): ?>
                            <a href="<?php echo e(route('nimbus.documents.index')); ?>" class="inline-flex h-[40px] w-full items-center justify-center gap-2 rounded-[5px] border border-ink-200 bg-white px-4 font-inter text-[12px] font-semibold uppercase tracking-[.1em] text-ink-700 no-underline transition-colors hover:bg-ink-50">
            ...
            <div class="overflow-hidden rounded-[8px] border border-ink-200 bg-white shadow-portal-subtle">
                <div class="flex flex-col gap-4 border-b border-ink-100 px-7 py-6 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        ...
                        <div class="font-jetbrains text-[11px] uppercase tracking-[.1em] text-ink-400">
                            <?php echo e($generalDocumentsCount); ?> documentos públicos visíveis · <?php echo e($privateDocumentsCount); ?> arquivos privados na sua área
                        </div>
                    </div>
                    <div class="flex flex-wrap items-center gap-2">
                        <div class="doc-meta-pill">Painel documental</div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($term)): ?>
                            <div class="doc-meta-pill doc-meta-pill-muted">Busca · <?php echo e($term); ?></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedCategory): ?>
                            <div class="doc-meta-pill doc-meta-pill-muted">Categoria · <?php echo e($selectedCategory->name); ?></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                ...
                <div class="px-7 pt-6">
                    <div class="doc-tabs mb-7">
                        <a href="#general" class="doc-tab on" data-doc-tab="general">
                            Documentos Gerais
                            <span class="count-pill"><?php echo e($generalDocumentsCount); ?></span>
                        </a>
                        <a href="#private" class="doc-tab" data-doc-tab="private">
                            Meus Documentos
                            <span class="count-pill"><?php echo e($privateDocumentsCount); ?></span>
                        </a>
                    </div>
                </div>
                ...
                <div class="px-7 pb-7">
                    <div class="tab-content">
                        <div class="tab-pane-custom active" id="general">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($documents->isEmpty()): ?>
                                <div class="doc-empty-state">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeFiltersCount > 0): ?>
                                        <a href="<?php echo e(route('nimbus.documents.index')); ?>" class="mt-6 inline-flex items-center justify-center gap-2 rounded-[5px] border border-ink-200 bg-white px-5 py-2.5 text-[13px] font-semibold text-ink-700 no-underline transition-colors hover:bg-ink-50">
                                            ...
                                            <div class="doc-card doc-card-general">
                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    <p class="line-clamp-3 font-inter text-[13px] leading-relaxed text-ink-500">
                                                        <?php echo e($document->description ?? 'Sem descrição disponível.'); ?>
                                                ...
                                                <div class="doc-card-meta">
                                                    <div>
                                                        ...
                                                        <div class="font-inter text-[13px] font-medium text-navy-900">
                                                            <?php echo e($document->published_at ? $document->published_at->format('d/m/Y') : ($document->created_at ? $document->created_at->format('d/m/Y') : '-')); ?>
                                                    ...
                                                    <div class="text-start md:text-right">
                                                        ...
                                                        <div class="font-inter text-[13px] font-medium text-navy-900">
                                                            <?php echo e($resolveDocumentType($document)); ?>

                                                        </div>
                                                        <div class="font-inter mt-1 text-[11.5px] text-ink-400">
                                                            <?php echo e($formatFileSize($document->file_size ?? null)); ?>
                                                ...
                                                <div class="mt-5 flex items-center justify-between gap-4">
                                                    <button
                                                        ...
                                                        data-open-preview
                                                        data-preview-url="<?php echo e(route('nimbus.documents.general.preview', $document)); ?>"
                                                        data-download-url="<?php echo e(route('nimbus.documents.general.download', $document)); ?>"
                                                        data-title="<?php echo e($document->title); ?>"
                                                    >
                                                    ...
                                                    <div class="flex items-center gap-2">
                                                        <a
                                                            href="<?php echo e(route('nimbus.documents.general.download', $document)); ?>"
                        ...
                        <div class="tab-pane-custom hidden" id="private">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($userDocs->isEmpty()): ?>
                                <div class="doc-empty-state">
                                    <div class="mb-4">
                            ...
                            <?php else: ?>
                                <div class="row g-6">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $userDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                        <div class="col-xl-6">
                                            <div class="doc-card doc-card-private">
                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    <p class="line-clamp-3 font-inter text-[13px] leading-relaxed text-ink-500">
                                                        <?php echo e($document->description ?? 'Documento privado disponível para a sua área.'); ?>
                                                ...
                                                <div class="doc-card-meta">
                                                    <div>
                                                        ...
                                                        <div class="font-inter text-[13px] font-medium text-navy-900">
                                                            <?php echo e($document->created_at ? $document->created_at->format('d/m/Y') : '-'); ?>
                                                ...
                                                <div class="mt-5 flex items-center justify-between gap-4">
                                                    <button
                                                        ...
                                                        class="doc-action-link"
                                                        data-open-preview
                                                        data-preview-url="<?php echo e(route('nimbus.documents.preview', $document)); ?>"
                                                        data-download-url="<?php echo e(route('nimbus.documents.download', $document)); ?>"
                                                        data-title="<?php echo e($document->title); ?>"
                                                    >
                                                        <span>Visualizar</span>
                                                        <i class="bi bi-arrow-up-right text-[11px]"></i>
                                                    ...
                                                    <div class="flex items-center gap-2">
                                                        <a
                                                            href="<?php echo e(route('nimbus.documents.download', $document)); ?>"
                                                            class="doc-btn-square"
                                                            title="Baixar"
                                                        >
                                                            <i class="bi bi-download"></i>
...
<?php echo $__env->make('nimbus.layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/desktop/projects/bsi-capital/resources/views/nimbus/documents/index.blade.php ENDPATH**/ ?>