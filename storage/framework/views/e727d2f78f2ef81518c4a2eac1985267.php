        ...
        <div class="row g-5">
            <div class="col-lg-4">
                <div class="pe-lg-4">
                    ...
                    <a href="<?php echo e(route('site.contact')); ?>" class="btn btn-brand btn-sm px-4 py-2">Consultar Tese de Estruturação</a>
                </div>
            </div>
            <div class="col-lg-8">
...
<?php echo $__env->make('site.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/desktop/projects/bsi-capital/resources/views/site/infra-empresas/estruturacao.blade.php ENDPATH**/ ?>